...
public class PaveCon {
	...
	/**
	 * Déplacer un point et son 'symétrique'
	 * @param indice
	 * @param Xpos
	 * @param Ypos
	 */
	...
	/**
	 * Supprimer un point et son point 'symétrique'
	 * @param indice
	 */
     ...
     * @param pointLon  L'ordonnée du point à évaluer
     * @param pointLat	L'abscisse du point à évaluer
     * @param lon 	Tableau d'ordonnées pour chaque sommet de la région
     * @param lat 	Un tableau d'abscisses pour chaque sommet de la région
     * @return true/false
     */
     ...
     * @param point 	Les coordonnées horizontales et verticales du point à juger
     * @param polygon 	Ensemble de coordonnées de sommet
     * @return 	true/false
     */
