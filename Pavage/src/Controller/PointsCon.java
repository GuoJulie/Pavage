...
public class PointsCon {
    ...
    /**
     * Calculer la distance point à ligne	计算点到线的距离
     * @param points0
     * @param points1
     * @param points2
     * @return double distance
    ...
    public double pointToLine (PointsM points0, PointsM points1, PointsM points2) {
        ...
        b = lineSpace(points1, points0);// (x1,y1)到点的距离	le distance entre le points1 et points0
        c = lineSpace(points2, points0);// (x2,y2)到点的距离	le distance entre le points2 et points0
        ...
        if (c <= 0.000001 || b <= 0.000001) {
         ...
         double p = (a + b + c) / 2;// 半周长	Demi circonférence
